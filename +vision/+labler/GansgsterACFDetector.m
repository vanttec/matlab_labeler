...
classdef GansgsterACFDetector < vision.labeler.AutomationAlgorithm
    ...
    properties(Constant)
        ...
        Name = 'GangsterDetector';
        
        % Description: Provide a one-line description for your algorithm.
        Description = 'This is acustom automation algorithm to automatically label gangster bouys for a dataset froom RoboSub.';
    ...
    methods
        ...
        function autoLabels = run(algObj, I)
            ...
            autoLabels = [];
            [bboxes,scores] = detect(algObj.GangsterDetector,I,...
